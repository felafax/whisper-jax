...
def measure_transcription_latency_felafax(file_path, num_loops=10):
    # API endpoint
    url = "http://api.felafax.ai:8000/transcribe/audio"
    ...
    print(f"Starting {num_loops} Felafax API transcription tests...")
    print(f"Audio duration: {audio_duration:.2f} seconds")
    print("-" * 50)
...
if __name__ == "__main__":
    ...
    results1 = measure_transcription_latency(audio_file, num_loops=10)
    
    print("\nTesting Felafax API:")
    results2 = measure_transcription_latency_felafax(audio_file, num_loops=10)